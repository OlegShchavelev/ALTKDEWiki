...
gallery:
  - type: slider
    items:
      - src: /alt-regular-kde/main.png
      - src: /alt-regular-kde/initial-setup.png
      - src: /alt-regular-kde/menu.png
  - type: slider
    items:
      - src: /alt-regular-kde/installer-sliders.png
      - src: /alt-regular-kde/installer-selection-of-packages.png
---
...
![Скриншот помощника первого запуска](/alt-regular-kde/plasma-welcome.png)
