...
Сценарий KWin, добавляющий «Динамические» рабочие столы: всегда держит пустой стол справа, автоматически создаёт новый при переносе окна на последний не занятый и удаляет пустые столы, когда они не нужны. Поведение максимально близко к концепции рабочих столов GNOME.
