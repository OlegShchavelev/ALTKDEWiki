...
appstream:
  ...
  summary: KWin сценарий для автоматического управления виртуальными рабочими столами
  developer:
    name: Ubiquitine
    nickname: Ubiquitine
  url:
...
KWin сценарий для автоматического создания и удаления виртуальных рабочих столов по аналогии с GNOME Shell. Рабочий стол автоматически удаляется при его освобождении, обеспечивая динамическое управление рабочим пространством без ручного вмешательства.
...
- Не требуется ручное создание и удаление рабочих столов
