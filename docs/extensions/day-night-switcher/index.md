...
Особенностью является возможность назначения пользовательских команд, которые будут выполняться при переключении на ту или иную тему, что расширяет функциональность для продвинутых пользователей.
