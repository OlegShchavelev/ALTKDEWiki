...
KWin‑сценарий, который «по‑настоящему» максимизирует рабочее пространство: скрывает заголовки окон при разворачивании и возвращает их при обычном размере. Полезно на небольших экранах и когда заголовки отвлекают от содержания.
...
|             Комбинация              |                     Описание                      |
| :---------------------------------: | :-----------------------------------------------: |
|       [[Meta]] + [[Page Up]]        | Вернуть окно из режима «по‑настоящему развернуто» |
