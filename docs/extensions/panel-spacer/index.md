...
- **Фиксированный размер** — указание точного размера в пикселях для создания постоянных отступов
...
Для центрирования виджетов на панели разместите по одному спейсеру в гибком режиме слева и справа от виджетов, которые хотите разместить по центру.
:::
