...
Эффект KWin, добавляющий плавные анимации при изменении геометрии окон: изменении размеров, перемещении и программных трансформациях скриптами или правилами окон. Длительность эффекта можно подстроить под свой рабочий темп.

![geometry-change-1](./img/geometry-change-1.gif)
...
- Настраиваемая длительность/ощущение плавности через параметры эффекта
