...
Виджет вдохновлён расширениями Active Blur и Blurred Wallpaper, но предоставляет значительно более широкий набор эффектов и настроек. В отличие от встроенных возможностей, поддерживает тонкую настройку условий активации эффектов и комбинирование различных визуальных преобразований.
...
::: tip Экономия места на экране
Виджет остаётся невидимым и не занимает места на рабочем столе. После установки не забудьте включить опцию **Hide widget** в настройках виджета для скрытия его визуального представления.
:::
