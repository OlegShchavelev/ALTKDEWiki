...
Все горячие клавиши можно изменить в разделе **Параметры системы** → **Клавиатура** → **Комбинации клавиш**. Некоторые комбинации по умолчанию конфликтуют со стандартными сочетаниями KDE и требуют ручной переназначения.
:::
