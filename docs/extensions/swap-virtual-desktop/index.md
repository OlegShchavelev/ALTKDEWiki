...
KWin сценарий, добавляющий расширенный набор горячих клавиш для продвинутого управления виртуальными рабочими столами. Позволяет быстро менять местами окна между рабочими столами, создавать и удалять рабочие столы с клавиатуры без использования мыши.
...
Сценарий может конфликтовать с другими расширениями, управляющими виртуальными рабочими столами, такими как Temporary Virtual Desktops или Dynamic Workspaces. Используйте только один сценарий для автоматического управления рабочими столами.
:::
